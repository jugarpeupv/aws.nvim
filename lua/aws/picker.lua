...
local services = {
  {
    ...
    action = function(co)
      require("aws.cloudformation").list_stacks(co)
    end,
  },
  {
    label = "S3",
    ...
    action = function(co)
      require("aws.s3").list_buckets(co)
    end,
  },
  {
    label = "CloudWatch",
    ...
    action = function(co)
      require("aws.cloudwatch").list_groups(co)
    end,
  },
  {
    label = "Lambda",
    ...
    action = function(co)
      require("aws.lambda").list_functions(co)
    end,
  },
  {
    label = "ACM",
    ...
    action = function(co)
      require("aws.acm").list_certificates(co)
    end,
  },
  {
    ...
    action = function(co)
      require("aws.secretsmanager").list_secrets(co)
    end,
  },
  {
    label = "CloudFront",
    ...
    action = function(co)
      require("aws.cloudfront").list_distributions(co)
    end,
  },
  {
    label = "API Gateway",
    ...
    action = function(co)
      require("aws.apigateway").list_apis(co)
    end,
  },
  {
    label = "ECS / Fargate",
    ...
    action = function(co)
      require("aws.ecs").list_clusters(co)
    end,
  },
  {
    label = "IAM",
  ...
  },
  {
    ...
    action = function(co)
      require("aws.dynamodb").list_tables(co)
    end,
  },
  {
    label = "EC2",
    ...
    action = function(co)
      require("aws.ec2").list_instances(co)
    end,
  },
}
